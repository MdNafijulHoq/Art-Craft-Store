...
const SignIn = () => {
    ...
    const {signIn, users, signInWithGoogle, signInWithGithub} = useContext(AuthContext);
    ...
    const handleSignIn = e => {
        ...
        .then(result => {
            ...
            // * if location.state exist then go to the state otherwise go to the homepage
    ...
    return (
        ...
        <form onSubmit={handleSignIn} noValidate="" action="" className="space-y-6">
            <div className="space-y-1 text-sm" bis_skin_checked="1">
                ...
                <input type="email" name="email" id="email" defaultValue={users?.email || ""} placeholder="leroy@jenkins.com" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800" required />
            </div>
            <div className="space-y-1 text-sm" bis_skin_checked="1">
    ...
    <div className="flex items-center border border-gray-300 rounded-md dark:border-gray-300 dark:bg-gray-50">
        ...
        <p className="text-xs text-center sm:px-6 dark:text-gray-600">Don't have an account?
            <Link to='/registration' rel="noopener noreferrer" href="#" className="underline text-blue-900 font-bold">Sign Up</Link>
        </p>
    </div>
