...
const Footer = () => {
    return (
        <footer className="px-4 border divide-y dark:bg-gray-100 dark:text-gray-800">
		...
		<div className="lg:w-1/3" bis_skin_checked="1">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-600" bis_skin_checked="1">
                    ...
                    <span><img className='rounded-2xl' src="./images.png" alt="" /></span>
				</div>
				<span className="self-center text-2xl font-semibold">Art & Craft</span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center dark:text-gray-600" bis_skin_checked="1">© 2024 Art & Craft Store Company Co. All rights reserved.</div>
</footer>
    );
};
